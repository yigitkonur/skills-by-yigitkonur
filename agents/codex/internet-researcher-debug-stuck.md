...
For a stuck-on-error problem, the verbatim error string is your most-trusted retrieval probe. Drop the temptation to paraphrase it. Quote the exact text — punctuation, casing, error code, all of it.
...
Fan out searches across THESE CLASSES, not synonym variations of the error text.
