...
## Cross-references
See also: [resource overview](../resource-management/01-overview.md), [acquire release](../resource-management/03-acquire-release.md), [scopes](../resource-management/02-scopes.md).
