...
> ⚠️ **Invitation-only mode.** When the invitation-only plugin is enabled, the signup form rejects users without a valid `invitationId`.

## Key files

- `apps/web/app/(saas)/auth/signup/page.tsx`
