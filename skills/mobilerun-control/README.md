...
1. **Project-level install (recommended):**
   ...
   ```bash
   # This skill only
   npx -y skills add -y yigitkonur/skills-by-yigitkonur/skills/mobilerun-control
...
2. **Global install (user-level):**
   ...
   ```bash
   # This skill only
   npx -y skills add -y -g yigitkonur/skills-by-yigitkonur/skills/mobilerun-control
