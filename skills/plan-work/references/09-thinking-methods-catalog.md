...
### Method selected without checking the selection table
...
### Method used without loading its reference file
...
### Two methods applied simultaneously instead of sequentially
...
### Thinking posture confused with method
...
### Skip-when conditions not checked before applying method
