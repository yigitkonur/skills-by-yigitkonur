...
1. **Language-specific pitfalls are supplements, not replacements.** Always apply the general bug patterns from `references/dimensions/bug-patterns.md` first, then layer on language-specific checks. Do not skip general review because the PR is "just TypeScript."
...
> **Cross-reference:** See `references/dimensions/bug-patterns.md` for the framework-agnostic bug patterns to apply first.
