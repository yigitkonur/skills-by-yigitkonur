...
Auditing a running web app's UI across pages and viewports, saving per-bug findings to a dated tree, and dispatching approval-gated fix subagents.
...
/plugin install audit-ui-and-save-files@yigitkonur
```
...
1. **Project-level install (recommended & PromptScript-compatible):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/audit-ui-and-save-files -y
   ...
   ```bash
   prs skills add github.com/yigitkonur/skills-by-yigitkonur/skills/audit-ui-and-save-files/SKILL.md
   ```
...
2. **Global install (user-level):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/audit-ui-and-save-files -y -g -a universal
