...
1. **Project-level install (recommended & PromptScript-compatible):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/update-agent-config -y
   ...
   ```bash
   prs skills add github.com/yigitkonur/skills-by-yigitkonur/skills/update-agent-config/SKILL.md
   ```
...
2. **Global install (user-level):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/update-agent-config -y -g -a universal
