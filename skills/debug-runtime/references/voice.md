...
This file scopes the voice discipline to debugging. For general completion-voice rules (e.g., "looks good", "probably fine" in status reports), see `skills/audit-completion/skills/audit-completion/references/voice-discipline.md` — the two are complementary, not overlapping.
...
- At done: "Phase 4 complete. Fix: <name>. Regression guard: <name>. Phase 1 repro: passes. Routing to audit-completion / declaring done."
