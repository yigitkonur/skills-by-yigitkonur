...
> This file is the **verbatim contents** to write to `<project>/css-issues/README.md` during Phase 2 of `do-ui-audit`. Every audit subagent reads this file as their format authority. Do not paraphrase — copy it byte-for-byte.
