...
**When:** Multi-line output with headings, lists, or emphasis. Client renders as markdown.
...
return {
  content: [
    { type: "text", text: "Generated chart:", mimeType: "text/markdown" },
