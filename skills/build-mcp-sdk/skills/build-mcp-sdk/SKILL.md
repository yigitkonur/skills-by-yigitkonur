...
Community adoption is still early (Q1 2026 release). Most production servers remain on v1.x. See `references/guides/v2-migration.md` for the full source-verified migration guide, or use `build-mcp-sdk-v2` for new v2 projects.
