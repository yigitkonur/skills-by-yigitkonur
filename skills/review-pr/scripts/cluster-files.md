...
Read-only file classifier for `review-pr`. It turns a changed-file list into a markdown cluster map grouped by data, security, API, core, frontend, infrastructure, configuration, documentation, tests, types, and mixed files.
