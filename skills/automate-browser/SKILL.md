...
1. **@refs** (from `snapshot -i`) — always prefer. Most stable, concise, and fast.
2. **Semantic locators** — `find role button click --name "Submit"`. Framework-agnostic, resilient to DOM changes.
...
DOM text is the source of truth. Screenshots supplement for human review. See [references/workflows.md](references/workflows.md) for full patterns.
...
| [references/workflows.md](references/workflows.md) | Reusable patterns: snapshot-first, error recovery, data extraction, multi-account testing |
| [references/safety.md](references/safety.md) | Risk-categorized commands, escalation policy, action policy, safe mode checklist |
