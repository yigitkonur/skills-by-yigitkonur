...
description: Use skill if you are building, modernizing, or reviewing macOS SwiftUI code with Apple's Liquid Glass design system — glass toolbars, sidebars, windows, NSGlassEffectView, or migrating from NSVisualEffectView.
---
