...
`run-codex-1` is a **skill**, not a plugin — so we ship the scripts as
...
The two hook scripts are intentionally **not** vendored. `run-codex-1`
...
DST=skills/run-codex-1/skills/run-codex-1/scripts/codex-cc
