...
No flags. Reads the dispatcher (`run-codex-1.mjs`) at the same path; runs 10 scenarios; reports pass/fail.

## Outputs

```
test-monitor-integration.mjs — run-codex-1 Monitor + dispatcher harness
