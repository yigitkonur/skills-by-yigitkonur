...
Deterministic checker for markdown audit tables and completion reports produced by `check-completion`.
...
Run it from the skill directory (`skills/check-completion/skills/check-completion/`) or pass the script path explicitly from elsewhere.
