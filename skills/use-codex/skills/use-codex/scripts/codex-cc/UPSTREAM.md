...
`use-codex` is a **skill**, not a plugin — so we ship the scripts as
...
The two hook scripts are intentionally **not** vendored. `use-codex`
...
DST=skills/use-codex/skills/use-codex/scripts/codex-cc
