...
No flags. Reads the dispatcher (`use-codex.mjs`) at the same path; runs 10 scenarios; reports pass/fail.

## Outputs

```
test-monitor-integration.mjs — use-codex Monitor + dispatcher harness
