#!/usr/bin/env bash
# bootstrap.sh — one-shot universal pre-flight for use-codex.
#
# What it does:
...
#      use-codex subdir. Manifest path is printed on stdout for the
...
STATE_DIR="$STATE_ROOT/$USE_CODEX_SLUG/use-codex"
...
# use-codex's worktree convention is `../<repo>-wt-<mode>-<slug>`,
...
# The dispatcher (use-codex.mjs) reads this block to populate the
