...
- The user wants to **review someone else's PR** for merge readiness → use `review-pr` instead.
- The user wants to **triage feedback already received** on a PR (comments, bot review, multi-reviewer streams) → use `review-feedback` instead.
