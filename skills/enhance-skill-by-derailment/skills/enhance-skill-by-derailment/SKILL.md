...
- Max 3 rounds. If friction does not decrease after 3 rounds, stop and route to `synthesize-skills` for redesign — do not keep piling warnings into a structurally weak skill.
