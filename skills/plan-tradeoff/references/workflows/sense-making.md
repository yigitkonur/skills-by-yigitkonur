...
If the task is a reproducible runtime bug → `debug-runtime`. If `debug-runtime` needs a falsifiable hypothesis handoff → `bug-tracing.md`. If symptoms recur after fixes → `recurring-issue.md`. Otherwise: this file.
