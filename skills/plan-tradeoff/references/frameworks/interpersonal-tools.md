...
These are niche tools for `plan-tradeoff` — most thinking sessions don't need them. Reach when the brainstorm's deliverable is a **conversation** with someone, not a code change.
