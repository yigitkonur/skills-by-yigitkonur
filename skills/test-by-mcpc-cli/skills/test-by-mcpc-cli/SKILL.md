...
- *Running an agentic-quality / hardening / context-budget audit beyond CLI testing* → use `optimize-agentic-mcp`
- *Porting an existing v1 server to v2* → use `convert-mcp-server-sdk-v1-to-v2`
