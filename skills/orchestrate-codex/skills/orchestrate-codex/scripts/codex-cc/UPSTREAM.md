...
`orchestrate-codex` is a **skill**, not a plugin — so we ship the scripts as
...
The two hook scripts are intentionally **not** vendored. `orchestrate-codex`
...
DST=skills/orchestrate-codex/skills/orchestrate-codex/scripts/codex-cc
