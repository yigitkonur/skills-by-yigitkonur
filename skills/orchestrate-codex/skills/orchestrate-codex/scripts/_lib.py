"""Shared Python helpers for orchestrate-codex.
...
Consumers:
  ...
  - orchestrate-codex.mjs (indirectly, via shelling out to these helpers)
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        print(
            "_lib.py — shared Python helpers for orchestrate-codex.\n"
            "Usage:\n"
