...
Use this file when you need to inherit the strongest ideas from earlier build-skill work without dragging over unnecessary bulk.
...
A strong build-skill contribution should feel:
