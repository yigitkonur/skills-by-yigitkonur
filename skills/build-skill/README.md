...
/plugin install build-skill@yigitkonur
```
...
1. **Project-level install (recommended & PromptScript-compatible):**
   ...
   ```bash
   prs skills add github.com/yigitkonur/skills-by-yigitkonur/skills/build-skill/SKILL.md
   ```
...
2. **Global install (user-level):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/build-skill -y -g -a universal
