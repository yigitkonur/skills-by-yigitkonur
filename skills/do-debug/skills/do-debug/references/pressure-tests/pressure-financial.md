...
- Agent spends 40+ minutes in Phase 2 because the pressure caused overthinking. Phase 1-2 has a budget (10-15 minutes total in outage mode); past that, route to `do-think` for faster evidence framing.
