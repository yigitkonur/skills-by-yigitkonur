...
- `timeout_seconds: 300` as *your* floor for real automation — the 60 s default reaps too aggressively. The API range is `10`–`259200` (72 h) and inactivity is polled every 5 s, so short-lived headless scrapes may legitimately go lower.
