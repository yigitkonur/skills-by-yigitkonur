...
|---|---|---|
| [audit-completion](skills/audit-completion/) | productivity | Audit what's done vs. claimed done via a 22-status taxonomy; remediate until every in-scope task reaches Implemented |
