...
| **[build-langchain-app](skills/build-langchain-app/)** | LangChain.js v1 and LangGraph.js in TypeScript — createAgent, LCEL composition, StateGraph workflows, tool calling with Zod, structured output, streaming, middleware (retry/fallback/HITL), RAG pipelines, memory/persistence, and OpenRouter integration. All 47 patterns live-tested. Includes 3 reference docs: pattern catalog, antipatterns, and decision tree. |
...
npx -y skills add -y -g yigitkonur/skills-by-yigitkonur/skills/build-langchain-app
```
