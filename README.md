...
45 skills for AI coding agents — agent configuration, code review, design extraction, browser automation, multi-agent orchestration, planning, research, project execution, SEO & marketing, framework guides, SDK guides, language standards, UI component libraries, CI/CD, OpenClaw platform, and skill research.
...
| **[develop-typebox-fastify](skills/develop-typebox-fastify/)** | Type-safe Fastify v5 REST API development with TypeBox schema validation, automatic OpenAPI generation, plugin architecture, hooks lifecycle, inject() testing, auth patterns, Drizzle/Prisma database integration, and production deployment. Includes 72 reference docs across 10 domains: TypeBox schemas (20), Fastify core (20), integration patterns, OpenAPI, database, middleware, project structure, deployment, and common patterns. |
| **[develop-macos-liquid-glass](skills/develop-macos-liquid-glass/)** | macOS Liquid Glass design system for SwiftUI and AppKit (macOS 26 Tahoe+) — design diagnosis workflow that reads existing views, spots dated patterns, and transforms them to Apple-native quality with glass toolbars, sidebars, and concentric shapes. Includes 7 reference docs: design principles, design diagnosis (41 deprecated APIs, 30 design smells with before/after), API reference, macOS patterns, migration guide, pitfalls, and AppKit bridging. |
...
npx -y skills add -y -g yigitkonur/skills-by-yigitkonur/skills/develop-typebox-fastify
...
npx -y skills add -y -g yigitkonur/skills-by-yigitkonur/skills/develop-macos-liquid-glass
```
