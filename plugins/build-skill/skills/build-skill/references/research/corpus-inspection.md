...
## Preparing notes for build-skill

If the corpus will feed into a `build-skill` workflow:
...
5. Show per-skill notes and quality-tier assessments inline in conversation output — this is the required evidence trail for `build-skill`
