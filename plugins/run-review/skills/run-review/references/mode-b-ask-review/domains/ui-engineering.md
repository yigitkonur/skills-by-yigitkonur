...
- [ ] Screenshot diff tool (Chromatic, Percy, or a snapshot harness) if available
...
| Ecosystem | Skill |
|---|---|
| macOS SwiftUI / AppKit (HIG, Liquid Glass, snapshots, hooks, Convex+Clerk) | — |
| SaaS design extraction | — |
