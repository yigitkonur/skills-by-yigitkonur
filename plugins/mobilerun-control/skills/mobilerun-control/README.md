...
Use skill if you are controlling, automating, or testing a connected Android phone via the mobilerun CLI — tapping, typing, swiping, reading the screen, or running a multi-step on-device task.
...
/plugin install mobilerun-control@yigitkonur
```
...
1. **Project-level install (recommended & PromptScript-compatible):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/mobilerun-control -y
   ...
   ```bash
   prs skills add github.com/yigitkonur/skills-by-yigitkonur/skills/mobilerun-control/SKILL.md
   ```
...
2. **Global install (user-level):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/mobilerun-control -y -g -a universal
