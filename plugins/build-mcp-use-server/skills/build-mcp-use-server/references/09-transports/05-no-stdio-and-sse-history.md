...
For multi-round workflows (e.g., "server initiates ask, client responds"), use `inputRequired.elicit()` within a tool handler or store state in an external database + polling.
