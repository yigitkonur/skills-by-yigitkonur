...
| **Resource read** | `ReadResourceResult` | `{ contents: [{ uri: "...", mimeType: "...", text?: "...", blob?: Uint8Array }] }` | `04-images-audio-binary-resources.md` |
| **Prompt messages** | `GetPromptResult` | `{ messages: [{ role: "user" \| "assistant", content: ContentBlock \| ContentBlock[] }] }` | (See 07-prompts) |
