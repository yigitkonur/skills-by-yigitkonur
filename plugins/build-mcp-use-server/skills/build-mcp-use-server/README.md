...
/plugin install build-mcp-use-server@yigitkonur
```
...
1. **Project-level install (recommended & PromptScript-compatible):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/build-mcp-use-server -y
   ...
   ```bash
   prs skills add github.com/yigitkonur/skills-by-yigitkonur/skills/build-mcp-use-server/SKILL.md
   ```
...
2. **Global install (user-level):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/build-mcp-use-server -y -g -a universal
