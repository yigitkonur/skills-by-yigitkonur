...
1. **Project-level install (recommended & PromptScript-compatible):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/audit-agentic-mcp -y
   ...
   ```bash
   prs skills add github.com/yigitkonur/skills-by-yigitkonur/skills/audit-agentic-mcp/SKILL.md
   ```
...
2. **Global install (user-level):**
   ...
   ```bash
   # This skill only
   npx -y skills add yigitkonur/skills-by-yigitkonur/skills/audit-agentic-mcp -y -g -a universal
