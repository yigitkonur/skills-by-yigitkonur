...
description: Use if turning documents, tools, or candidates into an interactive, weighted comparison matrix and executable Astro canvas comparison page.
---
...
| Topic | Reference |
|---|---|
| Criteria discovery guide | `references/criteria-discovery-guide.md` |
| Data type and scoring rubric | `references/data-type-and-scoring-rubric.md` |
| Executable template guide | `references/executable-template-guide.md` |
| JSON schema specification | `references/schema-specification.md` |
| Wave 1 prompt: Criteria expansion | `references/prompts/wave1-criteria-expansion.md` |
| Wave 2 prompt: Tool researcher | `references/prompts/wave2-tool-researcher.md` |
| Wave 3 prompt: Tool verifier | `references/prompts/wave3-tool-verifier.md` |
| Wave 4 prompt: Matrix assembly | `references/prompts/wave4-matrix-assembly.md` |
